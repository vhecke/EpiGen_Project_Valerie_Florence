---
title: "Histone Analysis memory vs. exhausted"
...
For the analysis, we split the workload in comparing naive and memory cells (part 1), naive and exhausted cells (part 2) and memory and exhausted cells (part3). 
...
# H3K27ac
H3K27ac_df <- read.table("NormRC_H3K27ac_wID.txt", header = TRUE)

# H3K27me3
H3K27me3_df <- read.table("NormRC_H3K27me3_wID.txt", header = TRUE)

# H3K4me3
H3K4me3_df <- read.table("NormRC_H3K4me3_wID.txt", header = TRUE)

# H3K9me3
H3K9me3_df <- read.table("NormRC_H3K9me3_wID.txt", header = TRUE)
...
# We want to visualize changes in histone modifications between the different cells (here: part 3, memory vs. exhausted). The intensity is defined as the mean expression of the histones over the 4 reps. We then want to plot only regions with significant changes, which we defined as log2 fold change >0.1 or <-0.1.

# H3K27ac
```{r}
H3K27ac_new <- H3K27ac_df[,-c(1:14)]

mean_memory_H3K27ac <- rowMeans(H3K27ac_new[, 1:4])   # memory day 30 cols
...
pseudocount <- 1e-6
log2FC_H3K27ac <- log2((mean_exh_H3K27ac + pseudocount) / (mean_memory_H3K27ac + pseudocount))
...
pheatmap(scaled_signal_H3K27ac, main = "H3K27ac (Memory & Exhausted) Significant Regions", show_rownames = FALSE, cutree_rows = 2)

```
# H3K27me3
```{r}
H3K27me3_new <- H3K27me3_df[,-c(1:14)]

mean_memory_H3K27me3 <- rowMeans(H3K27me3_new[, 1:4])   # memory day 30 cols
mean_exh_H3K27me3 <- rowMeans(H3K27me3_new[, 5:8])  #  exhausted day 32 cols

# Compute log2 fold change (memory / naive), add small pseudocount to avoid log2(0)
pseudocount <- 1e-6
log2FC_H3K27me3 <- log2((mean_exh_H3K27me3 + pseudocount) / (mean_memory_H3K27me3 + pseudocount))
...
pheatmap(scaled_signal_H3K27me3, main = "H3K27me3 (Memory & Exhausted) Significant Regions", show_rownames = FALSE, cutree_rows = 2)

```

#H3K4me3
```{r}
H3K4me3_new <- H3K4me3_df[,-c(1:14)]

mean_memory_H3K4me3 <- rowMeans(H3K4me3_new[, 1:4])   # memory day 30 cols
mean_exh_H3K4me3 <- rowMeans(H3K4me3_new[, 5:8])  #  exhausted day 32 cols

# Compute log2 fold change (memory / naive), add small pseudocount to avoid log2(0)
pseudocount <- 1e-6
log2FC_H3K4me3 <- log2((mean_exh_H3K4me3 + pseudocount) / (mean_memory_H3K4me3 + pseudocount))
...
pheatmap(scaled_signal_H3K4me3, main = "H3K4me3 (Memory & Exhausted) Significant Regions", show_rownames = FALSE, cutree_rows = 2)

```
#H3K9me3
```{r}
H3K9me3_new <- H3K9me3_df[,-c(1:14)]

mean_memory_H3K9me3 <- rowMeans(H3K9me3_new[, 1:4])   # memory day 30 cols
mean_exh_H3K9me3 <- rowMeans(H3K9me3_new[, 5:8])  #  exhausted day 32 cols

# Compute log2 fold change (memory / naive), add small pseudocount to avoid log2(0)
pseudocount <- 1e-6
log2FC_H3K9me3 <- log2((mean_exh_H3K9me3 + pseudocount) / (mean_memory_H3K9me3 + pseudocount))
...
pheatmap(scaled_signal_H3K9me3, main = "H3K9me3 (Memory & Exhausted) Significant Regions", show_rownames = FALSE, cutree_rows = 2)
```
...
pheatmap(top200_scaled_signal_H3K27ac, main = "H3K27ac (Memory & Exhausted) Top 200 Significant Regions", show_rownames = FALSE, cutree_rows = 2)
```
#H3K27me3 top 200
```{r}
...
pheatmap(top200_scaled_signal_H3K27me3, main = "H3K27me3 (Memory & Exhausted) Top 200 Significant Regions", show_rownames = FALSE, cutree_rows = 2)
```
#H3K9me3
```{r}
...
pheatmap(top200_scaled_signal_H3K9me3, main = "H3K9me3(Memory & Exhausted) Top 200 Significant Regions", show_rownames = FALSE, cutree_rows = 2)
```
...
pheatmap(top200_scaled_signal_H3K4me3, main = "H3K4me3 (Memory & Exhausted) Top 200 Significant Regions", show_rownames = FALSE, cutree_rows = 2)
```
